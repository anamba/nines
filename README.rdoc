...
gem install 'nines'
# create a config file in {YAML}[https://github.com/anamba/nines/blob/master/nines.yml.sample] or {ruby}[https://github.com/anamba/nines/blob/master/nines.rb.sample] format
